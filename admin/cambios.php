...
<html lang="es-ES">
    <head>
        <meta charset="UTF-8">
        <title>Cambios a usuarios</title>
                ...
                <section>
                    <table>
                        ...
                        <?php        
                            ...
                            <td><a class='eliminar' href='editarAlumno.php?id=".$dat->numControl."'>Editar</a></td></tr>";
                            }
                        ?>
                    </table>
                </section>
                <section>
                    <table>
                        ...
                        <?php        
                            ...
                            <td><a class='eliminar' href='editarPsicologo.php?id=".$dat->idpsicologo."'>Editar</a></td></tr>";
                            }
                        ?>
                    </table>
                </section>
